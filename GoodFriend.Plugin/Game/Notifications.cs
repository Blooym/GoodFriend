...
// namespace GoodFriend.Plugin.Game
// {
//     /// <summary>
...
//         private static void ShowToast(string message, ToastType type) => DalamudInjections.PluginInterface.UiBuilder.AddNotification(message, Constants.PluginName, type);

//         /// <summary> Sends a popup notification to the user. </summary>
//         /// <param name="message"> The message to send. </param>
//         private static void ShowPopup(string message) => DalamudInjections.Toast.ShowNormal(message);
...
//                 .AddText(message)
//                 .AddUiForegroundOff();
//             DalamudInjections.Chat.Print(stringBuilder.BuiltString);
//         }

//         /// <summary> Sends a quest complete popup notification to the user. </summary>
//         /// <param name="message"> The message to send. </param>
//         private static void ShowQuestPopup(string message) => DalamudInjections.Toast.ShowQuest(message, new QuestToastOptions
//         {
