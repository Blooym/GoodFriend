...
using GoodFriend.Plugin.UserInterface.ImGuiFullComponents.ConnectionStatusComponent;
using ImGuiNET;
...
namespace GoodFriend.Plugin.UserInterface.Windows.Main
{
    ...
    internal sealed class MainWindow : Window, IDisposable
    {
        ...
        public override void Draw()
        {
            ...
            if (ImGui.Button(PrimaryWindow.DropdownOptionsStatus, new Vector2((ImGui.GetWindowWidth() / 3) - 10, 0)))
            {
            ...
            SiGui.AddTooltip(statusPageUrl ?? "");
            ImGui.EndDisabled();
            ImGui.SameLine();

            // Donate button
            if (ImGui.Button(PrimaryWindow.DropdownOptionsSupport, new Vector2((ImGui.GetWindowWidth() / 3) - 10, 0)))
            {
                this.presenter.ToggleVisibleDropdown(MainPresenter.VisibleDropdown.Donate);
            }
            SiGui.AddTooltip(PrimaryWindow.DropdownOptionsSupportTooltip);
            ImGui.SameLine();

            // Settings button
            if (ImGui.Button(PrimaryWindow.DropdownOptionsSettings, new Vector2((ImGui.GetWindowWidth() / 3) - 10, 0)))
            {
                this.presenter.ToggleVisibleDropdown(MainPresenter.VisibleDropdown.Settings);
            }
            SiGui.AddTooltip(PrimaryWindow.DropdownOptionsSettingsTooltip);
        ...
        private void DrawSettings()
        {
            ...
            {
                SiGui.TextWrappedColoured(Colours.Warning, PrimaryWindow.DropdownSettingsRestartRequired);
            }
            ...
            if (ImGui.BeginTabBar("SettingsDropdownTabBar"))
            {
                ...
                if (ImGui.BeginTabItem(PrimaryWindow.SettingsTabGeneral))
                {
                    ...
                    if (ImGui.BeginTable("###GeneralSettingsTable", 2))
                    {
                        ...
                        SiGui.AddTooltip(PrimaryWindow.DropdownSettingsIgnoreFCTooltip);
                        ImGui.TableNextRow();
                        ...
                        SiGui.AddTooltip(PrimaryWindow.DropdownSettingsIgnoreDiffWorldsTooltip);
                        ImGui.TableNextRow();
                        ...
                        SiGui.AddTooltip(PrimaryWindow.DropdownSettingsIgnoreDiffHomeworldsTooltip);
                        ImGui.TableNextRow();
                        ...
                        SiGui.AddTooltip(PrimaryWindow.DropdownSettingsIgnoreDiffDatacentersTooltip);
                        ImGui.TableNextRow();
                        ...
                        SiGui.AddTooltip(PrimaryWindow.DropdownSettingsIgnoreDiffTerritoriesTooltip);
                        ImGui.TableNextRow();
                        ...
                        SiGui.AddTooltip(PrimaryWindow.DropdownSettingsNotificationTypeTooltip);
                        ImGui.TableNextRow();
                        ...
                        ImGui.TableSetColumnIndex(1);
                        ImGui.SetNextItemWidth(-1);
                        if (SiGui.InputText("##LoginMessage", ref loginMessage, 500, true))
                        {
                            var error = false;
...
#pragma warning restore CA1806 // Do not ignore method results
                        ...
                        SiGui.AddTooltip(PrimaryWindow.DropdownSettingsLoginMessageTooltip);
                        ImGui.TableNextRow();
                        ...
                        ImGui.TableSetColumnIndex(1);
                        ImGui.SetNextItemWidth(-1);
                        if (SiGui.InputText("##LogoutMessage", ref logoutMessage, 500, true))
                        {
                            var error = false;
#pragma warning disable CA1806 // Do not ignore method results
                            try
...
#pragma warning restore CA1806 // Do not ignore method results
                        ...
                        SiGui.AddTooltip(PrimaryWindow.DropdownSettingsLogoutMessageTooltip);
                ...
                if (ImGui.BeginTabItem(PrimaryWindow.SettingsTabAdvanced))
                {
                    ...
                    if (ImGui.BeginTable("SettingsTable", 2))
                    {
                        ...
                        SiGui.AddTooltip(PrimaryWindow.DropdownSettingsAPINotificationsTooltip);
                        ImGui.TableNextRow();
                        ...
                        ImGui.TableSetColumnIndex(1);
                        ImGui.SetNextItemWidth(-1);
                        if (SiGui.InputText("##APIUrl", ref apiUrl, 500, true))
                        {
...
#pragma warning restore CA1806 // Do not ignore method results
                        ...
                        SiGui.AddTooltip(PrimaryWindow.DropdownSettingsAPIUrlTooltip);
                        ImGui.TableNextRow();
                        ImGui.EndTable();
                    }
        ...
        private static void DrawSupport()
        {
            ...
            if (ImGui.Button(PrimaryWindow.DropdownSupportDonate))
            {
            ...
            if (donationPageUrl != null)
            {
                try
                {
                    ...
                    SiGui.AddTooltip(donationPageUrl);
                }
                catch
                {
